...
// @version      1.2.0
// @description  Export your ChatGPT conversations as clean Markdown files with improved accuracy
...
(function() {
    ...
    function findMessages() {
        ...
        for (const selector of selectors) {
            ...
            if (messages.length > 0) {
                console.log(`Userscript: Using selector: ${selector}, found ${messages.length} messages`);
                break;
            }
        }
        ...
        if (messages.length === 0) {
            ...
            if (conversationContainer) {
                ...
                console.log(`Userscript: Fallback: found ${messages.length} potential messages in conversation container`);
            }
        }
    ...
    function exportMarkdown() {
        ...
        console.log(`Userscript: Processing ${messages.length} messages...`);
        ...
        messages.forEach((messageElement, index) => {
            ...
            if (!content || content.trim().length < 30) {
                console.log(`Userscript: Skipping message ${index}: too short or empty`);
                return;
            }
            ...
            if (seenContent.has(contentHash)) {
                console.log(`Userscript: Skipping message ${index}: duplicate content`);
                return;
            }
        ...
        for (let i = 1; i < processedMessages.length; i++) {
            ...
            if (current.sender === previous.sender) {
                ...
                console.log(`Userscript: Fixed consecutive ${previous.sender} messages at positions ${i-1} and ${i}`);
            }
        }
        ...
        console.log(`Userscript: Export completed: ${processedMessages.length} messages exported`);
    }
