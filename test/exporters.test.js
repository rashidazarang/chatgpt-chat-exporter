...
test('separately identified identical turns remain in the export', async () => {
    ...
    assert.equal(conversation.messages.length, 2, 'distinct turn identities survive identical text');
